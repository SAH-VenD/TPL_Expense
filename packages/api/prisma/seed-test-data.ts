  ...
  const childDepts = [
    {
      ...
      code: 'TEST-ENG-FE',
      description: '[TEST] Frontend team',
      parentId: createdRoots[0].id,
    },
    {
    ...
    },
    {
      ...
      code: 'TEST-FIN-AP',
      description: '[TEST] AP team',
      parentId: createdRoots[1].id,
    },
    {
      name: '[TEST] Digital Marketing',
      code: 'TEST-MKT-DIG',
      description: '[TEST] Digital team',
      parentId: createdRoots[2].id,
    },
    {
      name: '[TEST] Logistics',
      code: 'TEST-OPS-LOG',
      description: '[TEST] Logistics team',
      parentId: createdRoots[3].id,
    },
  ];
  ...
  const rootCats = [
    {
      name: '[TEST] Travel',
      code: 'TEST-TRV',
      description: '[TEST] Travel expenses',
    ...
    },
    {
      name: '[TEST] Meals',
      code: 'TEST-MEL',
      description: '[TEST] Meal expenses',
      requiresReceipt: true,
    },
    {
      name: '[TEST] Software',
      code: 'TEST-SFT',
      description: '[TEST] Software subscriptions',
      requiresReceipt: true,
    },
    {
      name: '[TEST] Equipment',
      code: 'TEST-EQP',
      description: '[TEST] Equipment purchases',
      requiresReceipt: true,
  ...
  const childCats = [
    {
      name: '[TEST] Airfare',
      code: 'TEST-TRV-AIR',
      description: '[TEST] Flight tickets',
      parentId: createdRoots[0].id,
      requiresReceipt: true,
    },
    {
    ...
    },
    {
      ...
      code: 'TEST-OFF-STN',
      description: '[TEST] Stationery items',
      parentId: createdRoots[1].id,
      requiresReceipt: true,
    },
    {
      name: '[TEST] Client Meals',
      code: 'TEST-MEL-CLT',
      description: '[TEST] Client entertainment',
      parentId: createdRoots[2].id,
      requiresReceipt: true,
    },
    {
      name: '[TEST] Laptops',
      code: 'TEST-EQP-LAP',
      description: '[TEST] Laptop purchases',
      parentId: createdRoots[4].id,
      requiresReceipt: true,
      requiresPreApproval: true,
      maxAmount: 200000,
    },
...
async function seedVendors() {
  const vendorData = [
    {
      name: '[TEST] Pakistan Airlines',
      normalizedName: 'test_pakistan_airlines',
      taxId: 'NTN-1234567',
      isVerified: true,
    },
    {
      name: '[TEST] Marriott Hotel',
      normalizedName: 'test_marriott_hotel',
      taxId: 'NTN-2345678',
      isVerified: true,
    },
    {
      name: '[TEST] Office Depot',
      normalizedName: 'test_office_depot',
      taxId: 'NTN-3456789',
      isVerified: true,
    },
    {
      name: '[TEST] TechMart',
      normalizedName: 'test_techmart',
      taxId: 'NTN-4567890',
      isVerified: true,
    },
    ...
    {
      name: '[TEST] Shell Fuel',
      normalizedName: 'test_shell_fuel',
      taxId: 'NTN-5678901',
      isVerified: true,
    },
    {
      name: '[TEST] Microsoft',
      normalizedName: 'test_microsoft',
      taxId: 'NTN-6789012',
      isVerified: true,
    },
    {
      name: '[TEST] Amazon AWS',
      normalizedName: 'test_amazon_aws',
      taxId: 'NTN-7890123',
      isVerified: true,
    },
...
async function seedSystemSettings() {
  const settings = [
    {
      key: 'test_expense_limit_daily',
      value: { amount: 50000, currency: 'PKR' },
      description: '[TEST] Daily expense limit',
      category: 'limits',
    },
    {
      key: 'test_expense_limit_monthly',
      value: { amount: 500000, currency: 'PKR' },
      description: '[TEST] Monthly expense limit',
      category: 'limits',
    },
    {
      key: 'test_receipt_required_above',
      value: { amount: 1000 },
      description: '[TEST] Receipt required above this amount',
      category: 'policies',
    },
    {
      key: 'test_auto_approve_below',
      value: { amount: 5000 },
      description: '[TEST] Auto approve below this amount',
      category: 'policies',
    },
    {
      key: 'test_escalation_days',
      value: { days: 3 },
      description: '[TEST] Escalate after these many days',
      category: 'workflow',
    },
    {
      key: 'test_voucher_settlement_days',
      value: { days: 14 },
      description: '[TEST] Voucher settlement deadline',
      category: 'workflow',
    },
    {
      key: 'test_budget_warning_threshold',
      value: { percentage: 80 },
      description: '[TEST] Budget warning threshold',
      category: 'alerts',
    },
    {
      key: 'test_email_notifications',
      value: { enabled: true },
      description: '[TEST] Email notifications enabled',
      category: 'notifications',
    },
    {
      key: 'test_fiscal_year_start',
      value: { month: 7, day: 1 },
      description: '[TEST] Fiscal year start date',
      category: 'organization',
    },
    {
      key: 'test_currency_default',
      value: { currency: 'PKR' },
...
async function seedExchangeRates() {
  ...
  const rates = [
    { fromCurrency: 'USD', rate: 278.5, effectiveDate: today },
    { fromCurrency: 'GBP', rate: 352.3, effectiveDate: today },
    { fromCurrency: 'AED', rate: 75.8, effectiveDate: today },
    { fromCurrency: 'SAR', rate: 74.2, effectiveDate: today },
    { fromCurrency: 'USD', rate: 277.8, effectiveDate: new Date(today.getTime() - 86400000) },
    { fromCurrency: 'GBP', rate: 351.5, effectiveDate: new Date(today.getTime() - 86400000) },
    { fromCurrency: 'USD', rate: 279.1, effectiveDate: new Date(today.getTime() - 172800000) },
    { fromCurrency: 'GBP', rate: 353.0, effectiveDate: new Date(today.getTime() - 172800000) },
    { fromCurrency: 'AED', rate: 75.6, effectiveDate: new Date(today.getTime() - 86400000) },
    { fromCurrency: 'SAR', rate: 74.0, effectiveDate: new Date(today.getTime() - 86400000) },
  ] as const;
...
async function seedMileageRates() {
  const today = new Date();
  const rates = [
    { name: '[TEST] Car - Standard', vehicleType: 'CAR', ratePerKm: 25.0, effectiveFrom: today },
    {
    ...
    { name: '[TEST] Motorcycle', vehicleType: 'MOTORCYCLE', ratePerKm: 15.0, effectiveFrom: today },
    { name: '[TEST] Electric Vehicle', vehicleType: 'EV', ratePerKm: 20.0, effectiveFrom: today },
    { name: '[TEST] Van', vehicleType: 'VAN', ratePerKm: 40.0, effectiveFrom: today },
    {
      name: '[TEST] Car - Old Rate',
      vehicleType: 'CAR',
      ratePerKm: 22.0,
    ...
    { name: '[TEST] Bike', vehicleType: 'BICYCLE', ratePerKm: 5.0, effectiveFrom: today },
    { name: '[TEST] Truck', vehicleType: 'TRUCK', ratePerKm: 50.0, effectiveFrom: today },
    { name: '[TEST] SUV', vehicleType: 'SUV', ratePerKm: 30.0, effectiveFrom: today },
  ];
...
async function seedApprovalTiers() {
  const tiers = [
    ...
    {
      name: '[TEST] Equipment Pre-Approval',
      tierOrder: 2,
      minAmount: 0,
      maxAmount: 500000,
      approverRole: 'ADMIN',
...
async function seedCostCenters(departments: any[]) {
  const costCenters = [
    {
      name: '[TEST] CC - Engineering',
      code: 'TEST-CC-ENG',
      description: '[TEST] Engineering cost center',
      departmentId: departments[0].id,
    },
    {
      name: '[TEST] CC - Finance',
      code: 'TEST-CC-FIN',
      description: '[TEST] Finance cost center',
      departmentId: departments[1].id,
    },
    {
      name: '[TEST] CC - Marketing',
      code: 'TEST-CC-MKT',
      description: '[TEST] Marketing cost center',
      departmentId: departments[2].id,
    },
    {
      name: '[TEST] CC - Operations',
      code: 'TEST-CC-OPS',
      description: '[TEST] Operations cost center',
      departmentId: departments[3].id,
    },
    {
      name: '[TEST] CC - HR',
      code: 'TEST-CC-HR',
      description: '[TEST] HR cost center',
      departmentId: departments[4].id,
    },
    {
      name: '[TEST] CC - Research',
      code: 'TEST-CC-RND',
      description: '[TEST] R&D cost center',
      departmentId: departments[0].id,
    },
    {
      name: '[TEST] CC - Sales',
      code: 'TEST-CC-SAL',
      description: '[TEST] Sales cost center',
      departmentId: departments[2].id,
    },
    {
      name: '[TEST] CC - Support',
      code: 'TEST-CC-SUP',
      description: '[TEST] Support cost center',
      departmentId: departments[3].id,
    },
    { name: '[TEST] CC - Admin', code: 'TEST-CC-ADM', description: '[TEST] Admin cost center' },
    {
      name: '[TEST] CC - Facilities',
      code: 'TEST-CC-FAC',
      description: '[TEST] Facilities cost center',
    },
  ];
  ...
  const projects = [
    {
      ...
      code: 'TEST-PRJ-WEB',
      description: '[TEST] Corporate website redesign',
      clientName: 'Internal',
      startDate: today,
      isActive: true,
    },
    {
      ...
      code: 'TEST-PRJ-MOB',
      description: '[TEST] Customer mobile application',
    ...
    },
    {
      ...
      code: 'TEST-PRJ-ERP',
      description: '[TEST] ERP system rollout',
      clientName: 'Operations',
      startDate: new Date('2024-01-01'),
      isActive: true,
    },
    {
      name: '[TEST] Cloud Migration',
      code: 'TEST-PRJ-CLD',
      description: '[TEST] Infrastructure cloud migration',
      clientName: 'IT',
      startDate: today,
      isActive: true,
    },
    {
      ...
      code: 'TEST-PRJ-SEC',
      description: '[TEST] Annual security assessment',
      clientName: 'Compliance',
      startDate: today,
      endDate: new Date(today.getTime() + 90 * 86400000),
      isActive: true,
    },
    {
      name: '[TEST] Training Program',
      code: 'TEST-PRJ-TRN',
      description: '[TEST] Employee training initiative',
      clientName: 'HR',
      startDate: today,
      isActive: true,
    },
    {
      ...
      code: 'TEST-PRJ-MKT',
      description: '[TEST] Q1 marketing campaign',
      clientName: 'Marketing',
      startDate: today,
      endDate: new Date(today.getTime() + 60 * 86400000),
      isActive: true,
    },
    {
      name: '[TEST] Office Renovation',
      code: 'TEST-PRJ-REN',
      description: '[TEST] HQ office renovation',
      clientName: 'Facilities',
      startDate: today,
      isActive: true,
    },
    {
      ...
      code: 'TEST-PRJ-PRT',
      description: '[TEST] Customer self-service portal',
    ...
    },
    {
      ...
      code: 'TEST-PRJ-LEG',
      description: '[TEST] Completed legacy project',
      clientName: 'Internal',
...
async function seedUsers(departments: any[], passwordHash: string) {
  const users = [
    // 2 Admins
    {
      email: 'test.admin1@tekcellent.com',
    ...
    {
      email: 'test.admin2@tekcellent.com',
      firstName: '[TEST] Admin',
      lastName: 'Two',
    ...
    // 2 Finance
    {
      email: 'test.finance1@tekcellent.com',
      firstName: '[TEST] Finance',
      lastName: 'Manager',
    ...
    {
      email: 'test.finance2@tekcellent.com',
      firstName: '[TEST] Finance',
      lastName: 'Analyst',
    ...
    // 2 Approvers
    {
      email: 'test.approver1@tekcellent.com',
      firstName: '[TEST] Team',
      lastName: 'Lead',
    ...
    {
      email: 'test.approver2@tekcellent.com',
    ...
    // 4 Employees
    {
      email: 'test.employee1@tekcellent.com',
      firstName: '[TEST] John',
      lastName: 'Developer',
    ...
    {
      email: 'test.employee2@tekcellent.com',
      firstName: '[TEST] Jane',
      lastName: 'Designer',
    ...
    {
      email: 'test.employee3@tekcellent.com',
      firstName: '[TEST] Bob',
      lastName: 'Marketer',
    ...
    {
      email: 'test.employee4@tekcellent.com',
      firstName: '[TEST] Alice',
      lastName: 'Analyst',
      employeeId: 'TEST-EMP-010',
      role: 'EMPLOYEE',
      status: 'ACTIVE',
...
async function seedVendorCategoryMappings(vendors: any[], categories: any[]) {
  const mappings = [
    ...
    { vendorId: vendors[2].id, categoryId: categories[1].id, confidence: 0.9 }, // Office Depot -> Office Supplies
    { vendorId: vendors[3].id, categoryId: categories[4].id, confidence: 0.85 }, // TechMart -> Equipment
    { vendorId: vendors[4].id, categoryId: categories[2].id, confidence: 0.8 }, // Food Court -> Meals
    { vendorId: vendors[5].id, categoryId: categories[0].id, confidence: 0.9 }, // Uber -> Travel
...
async function seedBudgets(
  ...
  const budgets = [
    {
      name: '[TEST] Engineering Annual Budget',
      type: 'DEPARTMENT',
      period: 'ANNUAL',
      totalAmount: 5000000,
      usedAmount: 1500000,
    ...
    {
      name: '[TEST] Finance Quarterly Budget',
      type: 'DEPARTMENT',
      period: 'QUARTERLY',
      totalAmount: 1000000,
      usedAmount: 450000,
    ...
    {
      name: '[TEST] Marketing Monthly Budget',
      type: 'DEPARTMENT',
      period: 'MONTHLY',
      totalAmount: 500000,
      usedAmount: 380000,
    ...
    {
      name: '[TEST] Website Project Budget',
      type: 'PROJECT',
      period: 'PROJECT_BASED',
      totalAmount: 2000000,
      usedAmount: 800000,
      startDate: projects[0].startDate,
      endDate: new Date(today.getTime() + 180 * 86400000),
      projectId: projects[0].id,
      ownerId: users[4].id,
    },
    {
      name: '[TEST] Mobile App Budget',
      type: 'PROJECT',
      period: 'PROJECT_BASED',
      totalAmount: 3000000,
      usedAmount: 1200000,
    ...
    {
      name: '[TEST] Engineering CC Budget',
      type: 'COST_CENTER',
      period: 'ANNUAL',
      totalAmount: 1000000,
      usedAmount: 250000,
    ...
    {
      name: '[TEST] Travel Category Budget',
      type: 'CATEGORY',
      period: 'ANNUAL',
      totalAmount: 2000000,
      usedAmount: 900000,
...
async function seedApprovalDelegations(users: any[]) {
  ...
  const delegations = [
    ...
    },
    {
      ...
      endDate: new Date(today.getTime() + 21 * 86400000),
      reason: '[TEST] Conference attendance',
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      endDate: new Date(today.getTime() + 37 * 86400000),
    ...
    },
    {
      ...
      endDate: new Date(today.getTime() - 53 * 86400000),
      reason: '[TEST] Emergency coverage',
      isActive: false,
    },
    {
      fromUserId: users[2].id,
    ...
    },
    {
      ...
      endDate: new Date(today.getTime() + 52 * 86400000),
      reason: '[TEST] Planned absence',
      isActive: true,
    },
    {
      fromUserId: users[5].id,
      toUserId: users[0].id,
      startDate: new Date(today.getTime() + 60 * 86400000),
      endDate: new Date(today.getTime() + 67 * 86400000),
      reason: '[TEST] Business trip',
      isActive: true,
    },
    {
      fromUserId: users[4].id,
      ...
      endDate: new Date(today.getTime() + 97 * 86400000),
      reason: '[TEST] Future coverage',
      isActive: true,
    },
  ];
...
async function seedPreApprovals(users: any[], categories: any[]) {
  ...
  const preApprovals = [
    {
      preApprovalNumber: 'TEST-PRE-2026-001',
      status: 'APPROVED',
      requesterId: users[6].id,
      approverId: users[4].id,
      categoryId: categories[0].id,
      description: '[TEST] Business trip to Karachi',
      estimatedAmount: 150000,
      expectedDate: new Date(today.getTime() + 14 * 86400000),
      purpose: '[TEST] Client meeting',
      expiresAt: new Date(today.getTime() + 30 * 86400000),
      approvedAt: today,
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-002',
      status: 'PENDING',
      requesterId: users[7].id,
      categoryId: categories[4].id,
      description: '[TEST] New laptop purchase',
      estimatedAmount: 180000,
      expectedDate: new Date(today.getTime() + 7 * 86400000),
      purpose: '[TEST] Equipment upgrade',
      expiresAt: new Date(today.getTime() + 45 * 86400000),
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-003',
      status: 'APPROVED',
      requesterId: users[8].id,
      approverId: users[5].id,
      categoryId: categories[0].id,
      description: '[TEST] Marketing conference',
      estimatedAmount: 200000,
      expectedDate: new Date(today.getTime() + 21 * 86400000),
      purpose: '[TEST] Industry event',
      expiresAt: new Date(today.getTime() + 60 * 86400000),
      approvedAt: new Date(today.getTime() - 5 * 86400000),
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-004',
      status: 'REJECTED',
      requesterId: users[9].id,
      approverId: users[4].id,
      categoryId: categories[9].id,
      description: '[TEST] High-end workstation',
      estimatedAmount: 500000,
      rejectionReason: '[TEST] Budget constraints',
      expiresAt: new Date(today.getTime() + 30 * 86400000),
      rejectedAt: new Date(today.getTime() - 3 * 86400000),
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-005',
      status: 'USED',
      requesterId: users[6].id,
      approverId: users[4].id,
      ...
      purpose: '[TEST] Development tools',
      expiresAt: new Date(today.getTime() + 90 * 86400000),
      approvedAt: new Date(today.getTime() - 10 * 86400000),
      actualAmount: 48000,
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-006',
      status: 'EXPIRED',
      requesterId: users[7].id,
      approverId: users[5].id,
      categoryId: categories[0].id,
      description: '[TEST] Old travel request',
      estimatedAmount: 100000,
      expiresAt: new Date(today.getTime() - 15 * 86400000),
      approvedAt: new Date(today.getTime() - 60 * 86400000),
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-007',
      status: 'PENDING',
      requesterId: users[8].id,
      categoryId: categories[4].id,
      description: '[TEST] Office furniture',
      estimatedAmount: 75000,
      purpose: '[TEST] Ergonomic setup',
      expiresAt: new Date(today.getTime() + 30 * 86400000),
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-008',
      status: 'APPROVED',
      requesterId: users[9].id,
      approverId: users[0].id,
      categoryId: categories[0].id,
      description: '[TEST] Training seminar',
      estimatedAmount: 80000,
      expectedDate: new Date(today.getTime() + 30 * 86400000),
      purpose: '[TEST] Professional development',
      expiresAt: new Date(today.getTime() + 45 * 86400000),
      approvedAt: today,
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-009',
      status: 'PENDING',
      requesterId: users[6].id,
      categoryId: categories[9].id,
      description: '[TEST] Development server',
      estimatedAmount: 250000,
      purpose: '[TEST] Infrastructure upgrade',
      expiresAt: new Date(today.getTime() + 60 * 86400000),
    },
    {
      preApprovalNumber: 'TEST-PRE-2026-010',
      status: 'APPROVED',
      requesterId: users[7].id,
      approverId: users[4].id,
...
async function seedVouchers(users: any[]) {
  ...
  const vouchers = [
    {
      voucherNumber: 'TEST-VCH-2026-001',
      status: 'SETTLED',
      requesterId: users[6].id,
      ...
      settledAmount: 48500,
      purpose: '[TEST] Office supplies purchase',
      approvedAt: new Date(today.getTime() - 20 * 86400000),
      disbursedAt: new Date(today.getTime() - 18 * 86400000),
      settledAt: new Date(today.getTime() - 5 * 86400000),
      underSpendAmount: 1500,
      cashReturned: 1500,
    },
    {
      voucherNumber: 'TEST-VCH-2026-002',
      status: 'DISBURSED',
      requesterId: users[7].id,
      requestedAmount: 25000,
      approvedAmount: 25000,
      disbursedAmount: 25000,
      purpose: '[TEST] Event catering',
      settlementDeadline: new Date(today.getTime() + 7 * 86400000),
      approvedAt: new Date(today.getTime() - 5 * 86400000),
      disbursedAt: new Date(today.getTime() - 3 * 86400000),
    },
    {
      voucherNumber: 'TEST-VCH-2026-003',
      status: 'APPROVED',
      requesterId: users[8].id,
      requestedAmount: 75000,
      approvedAmount: 70000,
      purpose: '[TEST] Client gifts',
      notes: '[TEST] Reduced from requested amount',
      approvedAt: today,
    },
    {
      voucherNumber: 'TEST-VCH-2026-004',
      status: 'REQUESTED',
      requesterId: users[9].id,
      requestedAmount: 100000,
      purpose: '[TEST] Trade show expenses',
      notes: '[TEST] Pending approval',
    },
    {
      voucherNumber: 'TEST-VCH-2026-005',
      status: 'REJECTED',
      requesterId: users[6].id,
      requestedAmount: 200000,
      purpose: '[TEST] Equipment purchase',
      notes: '[TEST] Should use regular expense process',
    },
    {
      voucherNumber: 'TEST-VCH-2026-006',
      status: 'OVERDUE',
      requesterId: users[7].id,
      requestedAmount: 30000,
      approvedAmount: 30000,
      disbursedAmount: 30000,
      purpose: '[TEST] Training materials',
      settlementDeadline: new Date(today.getTime() - 5 * 86400000),
      approvedAt: new Date(today.getTime() - 25 * 86400000),
      disbursedAt: new Date(today.getTime() - 20 * 86400000),
    },
    {
      voucherNumber: 'TEST-VCH-2026-007',
      ...
      settledAmount: 35000,
      purpose: '[TEST] Marketing materials',
      settlementDeadline: new Date(today.getTime() + 3 * 86400000),
      approvedAt: new Date(today.getTime() - 15 * 86400000),
      disbursedAt: new Date(today.getTime() - 12 * 86400000),
    },
    {
      voucherNumber: 'TEST-VCH-2026-008',
      status: 'SETTLED',
      requesterId: users[9].id,
      ...
      settledAmount: 42500,
      purpose: '[TEST] Office repairs',
      approvedAt: new Date(today.getTime() - 30 * 86400000),
      disbursedAt: new Date(today.getTime() - 28 * 86400000),
      settledAt: new Date(today.getTime() - 15 * 86400000),
      overSpendAmount: 2500,
    },
    {
      voucherNumber: 'TEST-VCH-2026-009',
      status: 'DISBURSED',
      requesterId: users[6].id,
      requestedAmount: 80000,
      approvedAmount: 80000,
      disbursedAmount: 80000,
      purpose: '[TEST] Team retreat',
      settlementDeadline: new Date(today.getTime() + 14 * 86400000),
      approvedAt: new Date(today.getTime() - 3 * 86400000),
      disbursedAt: today,
    },
    {
      voucherNumber: 'TEST-VCH-2026-010',
      status: 'REQUESTED',
      requesterId: users[7].id,
      requestedAmount: 15000,
      purpose: '[TEST] Office snacks',
      notes: '[TEST] Monthly pantry supplies',
    },
  ] as const;
  ...
  const splits = [
    {
      ...
      amount: 35000,
      percentage: 77.78,
      description: '[TEST] Airfare portion',
    },
    {
      expenseId: expenses[0].id,
      categoryId: categories[0].id,
      amount: 10000,
      percentage: 22.22,
      description: '[TEST] Airport transfers',
    },
    {
    ...
    },
    {
      ...
      amount: 3000,
      percentage: 10.71,
      description: '[TEST] Room service meals',
    },
    {
      ...
      amount: 8000,
      percentage: 64.0,
      description: '[TEST] Printer paper and toner',
    },
    {
      expenseId: expenses[4].id,
      categoryId: categories[1].id,
      amount: 4500,
      percentage: 36.0,
      description: '[TEST] Pens and notebooks',
    },
    {
      expenseId: expenses[8].id,
      categoryId: categories[2].id,
      amount: 15000,
      percentage: 68.18,
      description: '[TEST] Main catering',
    },
    {
      expenseId: expenses[8].id,
      categoryId: categories[2].id,
    ...
    {
      expenseId: expenses[9].id,
      categoryId: categories[3].id,
      amount: 100,
      percentage: 66.67,
      description: '[TEST] EC2 instances',
    },
    {
      expenseId: expenses[9].id,
      categoryId: categories[3].id,
...
async function seedReceipts(expenses: any[]) {
  ...
  const receipts = [
    {
      expenseId: expenses[0].id,
      fileName: 'test-receipt-001.pdf',
      originalName: '[TEST] PIA_Ticket_Receipt.pdf',
      mimeType: 'application/pdf',
      fileSize: 125000,
      s3Key: 'test/receipts/001.pdf',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.92,
    },
    {
      expenseId: expenses[1].id,
      fileName: 'test-receipt-002.jpg',
      originalName: '[TEST] Marriott_Invoice.jpg',
      mimeType: 'image/jpeg',
      fileSize: 850000,
      s3Key: 'test/receipts/002.jpg',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.88,
    },
    {
      ...
      fileName: 'test-receipt-003.png',
      originalName: '[TEST] Lunch_Bill.png',
      mimeType: 'image/png',
      fileSize: 420000,
      s3Key: 'test/receipts/003.png',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'pending',
    },
    {
      expenseId: expenses[4].id,
      fileName: 'test-receipt-004.pdf',
      originalName: '[TEST] Office_Depot_Receipt.pdf',
      mimeType: 'application/pdf',
      fileSize: 95000,
      s3Key: 'test/receipts/004.pdf',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.95,
    },
    {
      ...
      fileName: 'test-receipt-005.pdf',
      originalName: '[TEST] Microsoft_Invoice.pdf',
      mimeType: 'application/pdf',
      fileSize: 180000,
      s3Key: 'test/receipts/005.pdf',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.91,
    },
    {
      ...
      fileName: 'test-receipt-006.jpg',
      originalName: '[TEST] Restaurant_Bill.jpg',
      mimeType: 'image/jpeg',
      fileSize: 650000,
      s3Key: 'test/receipts/006.jpg',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.85,
    },
    {
      expenseId: expenses[8].id,
      fileName: 'test-receipt-007.pdf',
      originalName: '[TEST] Catering_Invoice_1.pdf',
      mimeType: 'application/pdf',
      fileSize: 110000,
      s3Key: 'test/receipts/007.pdf',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.89,
    },
    {
      expenseId: expenses[8].id,
      fileName: 'test-receipt-008.pdf',
      originalName: '[TEST] Catering_Invoice_2.pdf',
      mimeType: 'application/pdf',
      fileSize: 105000,
      s3Key: 'test/receipts/008.pdf',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.87,
    },
    {
      expenseId: expenses[9].id,
      fileName: 'test-receipt-009.pdf',
      originalName: '[TEST] AWS_Invoice.pdf',
      mimeType: 'application/pdf',
      fileSize: 220000,
      s3Key: 'test/receipts/009.pdf',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.96,
    },
    {
      expenseId: expenses[0].id,
      fileName: 'test-receipt-010.jpg',
      originalName: '[TEST] Boarding_Pass.jpg',
      mimeType: 'image/jpeg',
      fileSize: 380000,
      s3Key: 'test/receipts/010.jpg',
      s3Bucket: 'tpl-expense-test',
      ocrStatus: 'completed',
      ocrConfidence: 0.82,
    },
  ...
  const comments = [
    {
      expenseId: expenses[0].id,
      authorId: users[4].id,
      content: '[TEST] Approved. Good documentation provided.',
      createdAt: new Date(today.getTime() - 9 * 86400000),
    },
    {
      expenseId: expenses[1].id,
      authorId: users[4].id,
      content: '[TEST] Please confirm the room rate matches our corporate discount.',
      createdAt: new Date(today.getTime() - 1 * 86400000),
    },
    {
      expenseId: expenses[1].id,
      authorId: users[7].id,
      content: '[TEST] Yes, this is our negotiated corporate rate of PKR 14,000/night.',
      createdAt: today,
    },
    {
      expenseId: expenses[3].id,
      authorId: users[4].id,
      content: '[TEST] Rejected due to missing receipt. Please resubmit with proper documentation.',
      createdAt: new Date(today.getTime() - 5 * 86400000),
    },
    {
      expenseId: expenses[5].id,
      authorId: users[2].id,
      content: '[TEST] Need license confirmation before approval.',
      createdAt: new Date(today.getTime() - 3 * 86400000),
    },
    {
      expenseId: expenses[7].id,
      authorId: users[9].id,
      content: '[TEST] Resubmitting with scanned receipt attached.',
      createdAt: today,
    },
    {
      expenseId: expenses[8].id,
      authorId: users[4].id,
      content: '[TEST] Approved for voucher settlement.',
      createdAt: new Date(today.getTime() - 10 * 86400000),
    },
    {
      expenseId: expenses[9].id,
      authorId: users[2].id,
      content: '[TEST] Foreign currency expense approved. Exchange rate verified.',
      createdAt: new Date(today.getTime() - 28 * 86400000),
    },
    {
      expenseId: expenses[6].id,
      authorId: users[5].id,
      content: '[TEST] Mileage claim looks correct. Awaiting final approval.',
      createdAt: today,
    },
    {
      expenseId: expenses[2].id,
      authorId: users[8].id,
      content: '[TEST] Draft saved. Will submit after adding receipt.',
      createdAt: today,
    },
  ];
  ...
  const notifications = [
    {
      ...
      message: '[TEST] Your expense EXP-2026-001 has been approved.',
      entityType: 'Expense',
      isRead: true,
      readAt: new Date(today.getTime() - 8 * 86400000),
      createdAt: new Date(today.getTime() - 9 * 86400000),
    },
    {
      userId: users[7].id,
      type: 'CLARIFICATION_REQUESTED',
      title: '[TEST] Clarification Needed',
      message: '[TEST] Please provide additional details for expense EXP-2026-006.',
      entityType: 'Expense',
      isRead: false,
      createdAt: new Date(today.getTime() - 3 * 86400000),
    },
    {
      ...
      title: '[TEST] New Expense for Review',
      message: '[TEST] John Developer submitted an expense requiring your approval.',
      entityType: 'Expense',
      isRead: false,
      createdAt: today,
    },
    {
      ...
      message: '[TEST] Marketing monthly budget has reached 76% utilization.',
      entityType: 'Budget',
      isRead: true,
      readAt: today,
    ...
    },
    {
      ...
      title: '[TEST] Voucher Settlement Overdue',
      message: '[TEST] Voucher VCH-2026-006 is past its settlement deadline.',
      entityType: 'Voucher',
      isRead: false,
      createdAt: new Date(today.getTime() - 5 * 86400000),
    },
    {
      ...
      message: '[TEST] Your expense EXP-2026-004 has been rejected.',
      entityType: 'Expense',
      isRead: true,
      readAt: new Date(today.getTime() - 4 * 86400000),
      createdAt: new Date(today.getTime() - 5 * 86400000),
    },
    {
      userId: users[5].id,
      type: 'DELEGATION_STARTED',
      title: '[TEST] Delegation Active',
      message: '[TEST] You are now receiving approval requests delegated from Team Lead.',
    ...
    },
    {
      ...
      title: '[TEST] Pre-Approval Expiring',
      message: '[TEST] Your pre-approval PRE-2026-002 expires in 5 days.',
      entityType: 'PreApproval',
      isRead: false,
      createdAt: new Date(today.getTime() - 1 * 86400000),
    },
    {
      ...
      message: '[TEST] Employee 2 monthly budget has exceeded the limit.',
      entityType: 'Budget',
      isRead: false,
      createdAt: today,
    },
    {
      userId: users[6].id,
      type: 'VOUCHER_DISBURSED',
      title: '[TEST] Voucher Disbursed',
      message: '[TEST] Your voucher VCH-2026-009 has been disbursed.',
      entityType: 'Voucher',
      isRead: false,
      createdAt: today,
    },
